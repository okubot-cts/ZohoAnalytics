...
def setup_zoho_books():
    """Zoho Books初回認証の手順を表示"""
    ...
    print("\npython3 get_books_token.py [認証コード]")
    print("\n例:")
    print("python3 get_books_token.py 1000.a1b2c3d4e5f6...")
    print("="*60)
