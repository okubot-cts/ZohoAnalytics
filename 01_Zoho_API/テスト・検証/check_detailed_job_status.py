    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'data' in data and isinstance(data['data'], list):
                ...
                output_file = f"versant_detailed_result_{timestamp}.json"
