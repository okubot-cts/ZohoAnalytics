...
# -*- coding: utf-8 -*-
"""
シンプルなZohoCRM認証ワークフロー作成スクリプト
基本的な認証機能とリフレッシュトークン機能を含む
"""
...
def create_simple_auth_workflow():
    ...
    print("=== シンプルなZohoCRM認証ワークフロー作成 ===\n")
    
    # シンプルな認証ワークフロー
    workflow = {
        "name": "Zoho CRM - Simple Auth System",
        "description": "ZohoCRM認証とリフレッシュトークン機能",
        "active": True,
        "settings": {
            "executionOrder": "v1"
        },
            ...
            if workflow_id:
                ...
                if activate_response.status_code == 200:
                    ...
                    workflow_path = os.path.join(
                        ...
                        '../ワークフロー/zoho_simple_auth_workflow.json'
                    )
...
## 概要
このワークフローは、ZohoCRMの認証システムとリフレッシュトークン機能を含むシンプルな認証システムです。
...
"""
    ...
    guide_path = os.path.join(
        os.path.dirname(__file__),
        '../ドキュメント/zoho_simple_auth_guide.md'
    )
