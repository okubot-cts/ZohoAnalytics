#!/usr/bin/env python3
"""
VERSANT Coaching Report Minimal Execution Script
Executes the minimal VERSANT coaching report SQL query
"""
...
def execute_versant_minimal():
    """Execute the minimal VERSANT coaching report"""
    ...
    # Read the minimal SQL query
    sql_file_path = "versant_coaching_report_minimal.sql"
    
    try:
        with open(sql_file_path, 'r', encoding='utf-8') as f:
            sql_query = f.read()
        
        print(f"📋 Executing minimal VERSANT coaching report query...")
        ...
        if result:
            ...
            output_filename = f"versant_minimal_result_{timestamp}.json"
            
            # Save results to JSON file
            with open(output_filename, 'w', encoding='utf-8') as f:
                json.dump(result, f, ensure_ascii=False, indent=2)
            
            print(f"✅ Minimal VERSANT coaching report executed successfully!")
