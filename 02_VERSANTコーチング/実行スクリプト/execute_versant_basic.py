#!/usr/bin/env python3
"""
VERSANT Coaching Report Basic Execution Script
Executes the basic VERSANT coaching report SQL query
"""
...
def execute_versant_basic():
    """Execute the basic VERSANT coaching report"""
    ...
    # Read the basic SQL query
    sql_file_path = "versant_coaching_report_basic.sql"
    
    try:
        with open(sql_file_path, 'r', encoding='utf-8') as f:
            sql_query = f.read()
        
        print(f"📋 Executing basic VERSANT coaching report query...")
        ...
        if result:
            ...
            output_filename = f"versant_basic_result_{timestamp}.json"
            
            # Save results to JSON file
            with open(output_filename, 'w', encoding='utf-8') as f:
                json.dump(result, f, ensure_ascii=False, indent=2)
            
            print(f"✅ Basic VERSANT coaching report executed successfully!")
