#!/usr/bin/env python3
"""
VERSANT Coaching Report Complete Execution Script
Executes the complete VERSANT coaching report with account, product master, and learning start date
"""
...
def execute_versant_complete():
    """Execute the complete VERSANT coaching report with all enhancements"""
    ...
    # Read the complete SQL query
    sql_file_path = "versant_coaching_report_complete.sql"
    
    try:
        with open(sql_file_path, 'r', encoding='utf-8') as f:
            sql_query = f.read()
        
        print(f"📋 Executing complete VERSANT coaching report...")
        ...
        print(f"🏢 Includes: Account name, Product name, Learning start date")
        print()
        ...
        if result:
            ...
            output_filename = f"versant_complete_result_{timestamp}.json"
            
            # Save results to JSON file
            with open(output_filename, 'w', encoding='utf-8') as f:
                json.dump(result, f, ensure_ascii=False, indent=2)
            
            print(f"✅ Complete VERSANT coaching report executed successfully!")
            ...
            if result.get('data'):
                ...
                for record in result['data']:
                    ...
                    product = record.get('商品名', 'Unknown')
                ...
                for record in result['data']:
                    if record.get('メールアドレス') == target_email:
                        ...
                        product_name = record.get('商品名', 'Unknown')
